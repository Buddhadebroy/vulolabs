 ...
 * keys, mirroring VuloLabs\Utill's and VuloPilot\Utill's role for their
...
class Utill {
     ...
     * VuloLabs\Utill::ACTIVE_MODULES_DB_KEY's/VuloPilot\Utill's role
     ...
     * (not vulolabs's per-tab-namespaced `admin_settings` shape,
     ...
     * mirrors VuloLabs\Utill::is_khali_dabba()'s/VuloPilot\Utill's role
