 ...
 * `VuloLabs\Admin`/`VuloPilot\Admin` exactly: real `add_submenu_page()`
 ...
 * vulolabs-pro/vulopilot-pro relationship (Pro extends Free's
...
class Menu {
    ...
    public function add_menu() {
        ...
        // explicit "Dashboard" tab above. vulolabs/vulopilot both strip
        // this the same way rather than avoiding it (Admin.php's own
        // `remove_submenu_page( 'vulolabs', 'vulolabs' )` /
     ...
     * top-level menus, and VuloLabs gives its own marketplace admin.
     *
