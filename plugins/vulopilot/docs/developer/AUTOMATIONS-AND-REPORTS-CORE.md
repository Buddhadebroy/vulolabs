...
Code reference for `classes/Automations`, `classes/Utill` (scan/finding pipeline) and `classes/Reports`. User views: [../user/AUTOMATIONS.md](../user/AUTOMATIONS.md), [../user/REPORTS.md](../user/REPORTS.md).
...
| `AutomationsRepository` | `classes/Automations/AutomationsRepository.php` | - |
| `AutomationsRunRepository` | `classes/Automations/AutomationsRunRepository.php` | - |
...
| `FindingRepository` | `classes/Utill/FindingRepository.php` | - |
...
| `RepositoryInterface` | `classes/Utill/RepositoryInterface.php` | - |
...
| `ScanRepository` | `classes/Utill/ScanRepository.php` | - |
