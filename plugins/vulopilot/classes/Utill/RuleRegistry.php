...
class RuleRegistry {
	...
	private function get_default_rule_classes(): array {
		return array(
			...
			\VuloPilot\Commerce\MissingProductDescriptionRule::class,
			\VuloPilot\Commerce\MissingProductShortDescriptionRule::class,
			\VuloPilot\Commerce\MissingProductAttributesRule::class,
			\VuloPilot\Commerce\DuplicateProductSkuRule::class,
			\VuloPilot\Commerce\MissingProductPriceRule::class,
			\VuloPilot\Commerce\ProductInventoryIssueRule::class,
			\VuloPilot\Commerce\DuplicateProductRule::class,
			\VuloPilot\Commerce\LowProductCompletenessRule::class,
			\VuloPilot\Commerce\MissingProductCategoryRule::class,
		);
	}
