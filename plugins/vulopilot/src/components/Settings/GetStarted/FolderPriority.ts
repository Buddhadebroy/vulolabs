export default {
	...
	// sub-tab, Connections). Now 3 real sub-tabs: Connections (this
	// folder's own original content, `priority: 1`), Title Formats and
	// Business Information (both moved in from the old Site Identity
	// folder per direct instruction, "move this 2 sub tab in Get
	...
	// that top-level folder is gone rather than left empty.
