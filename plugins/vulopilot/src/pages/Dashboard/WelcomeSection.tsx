 ...
 * (VuloLabs/dualcube, confirmed via the plugin header's Author URI),
...
/**
 * Same destinations VuloLabs's own "Need help getting started?" card
 ...
 * `vulolabs`) so traffic from this dashboard is attributed
...
export const HELP_RESOURCES = [
	{
		...
		href: 'https://vulolabs.com/docs/knowledgebase/?utm_source=wpadmin&utm_medium=pluginsettings&utm_campaign=vulopilot',
	},
	{
		...
		href: 'https://vulolabs.com/custom-development/?utm_source=wpadmin&utm_medium=pluginsettings&utm_campaign=vulopilot',
	},
	{
 ...
 * directly on the free vulolabs plugin's own admin dashboard welcome
