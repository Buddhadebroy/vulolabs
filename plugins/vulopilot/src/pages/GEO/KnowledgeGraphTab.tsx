 ...
 * Extraction (6 real, deterministic entity types,
 * KNOWLEDGE-GRAPH-MODULE.md) plus vulopilot-pro's own Graph
 * Visualization/Entity Recommendations/Knowledge Graph Health cards. Body
 * extracted verbatim from the former standalone KnowledgeGraph.tsx page —
 * its own NavigatorHeaderComponent now lives once on GEO.tsx's shared
 * tab-shell header.
 */
