...
/**
 * Today's whole Reports.tsx page body, extracted verbatim (functionality
 * completely unchanged) and given an `id` anchor so
 * ReportsHeroCard.tsx/ReportTypeCards.tsx's "real scroll to the real
